...
interesado al trabajo de A. García y G. Simari\cite{delp04}. 
...
\begin{definicion}(Programa \DLP\ \PP)
	...
	conocimiento estricto involucra \textit{reglas estrictas} de la forma \srule{L}{Q_1,\ldots,Q_k} y 
	\textit{hechos} (reglas estrictas con cuerpo vacío), y se asume que es \textit{no-contradictorio}. 
