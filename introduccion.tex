...
% enfocará la investigación a la plataforma propuesta en el Multi-Agent
% Programming Contest, un juego académico donde agentes independientes
...
% progreso y a un paso más lento. Además, muchas de las herramientas
